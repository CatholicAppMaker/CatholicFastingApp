...
TESTS=(
  ...
  "CatholicFastingAppUITests/testDeepDashboardOpenCalendarQuickAction"
  "CatholicFastingAppUITests/testSmokeCalendarFilterControlsVisible"
  "CatholicFastingAppUITests/testDeepCalendarResetFiltersButtonVisible"
