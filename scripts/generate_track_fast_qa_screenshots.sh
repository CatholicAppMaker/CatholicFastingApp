...
OUTPUT_ROOT="$ROOT_DIR/release/qa-screenshots/track-fast"
RESULTS_DIR="$ROOT_DIR/build/track-fast-qa-screenshots"
...
Usage:
  scripts/generate_track_fast_qa_screenshots.sh [options]

Options:
  --iphone-only           Capture only the iPhone Track Fast QA set.
  --ipad-only             Capture only the iPad Track Fast QA set.
  --output DIR            Screenshot output root. Defaults to release/qa-screenshots/track-fast.
