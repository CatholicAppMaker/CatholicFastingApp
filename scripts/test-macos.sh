...
verify_release_contract() {
  ...
  assert_file_contains Configurations/macOS/MacSharedDebug.xcconfig "MARKETING_VERSION = 5.0"
  assert_file_contains Configurations/macOS/MacSharedRelease.xcconfig "MARKETING_VERSION = 5.0"
