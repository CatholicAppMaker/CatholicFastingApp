...
This file is the source of truth for App Store Connect metadata, subscription presentation, and
legal-link alignment for the Catholic Fasting 4.0 release.
...
4. App description and review notes no longer describe the app as U.S.-only if Canada baseline
   support is claimed.
5. No dead or placeholder URLs remain.
6. If pricing is changed at launch, screenshots and visible price references are refreshed before
   submission.
