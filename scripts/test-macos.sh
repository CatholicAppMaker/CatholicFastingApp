...
verify_release_contract() {
	...
	assert_file_contains Configurations/macOS/MacSharedDebug.xcconfig "MARKETING_VERSION = 6.0"
	assert_file_contains Configurations/macOS/MacSharedRelease.xcconfig "MARKETING_VERSION = 6.0"
	assert_file_contains Configurations/macOS/MacSharedDebug.xcconfig "CURRENT_PROJECT_VERSION = 5"
	assert_file_contains Configurations/macOS/MacSharedRelease.xcconfig "CURRENT_PROJECT_VERSION = 5"
