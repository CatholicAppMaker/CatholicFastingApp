...
verify_release_contract() {
  ...
  assert_file_contains Configurations/macOS/MacSharedDebug.xcconfig "CURRENT_PROJECT_VERSION = 15"
  assert_file_contains Configurations/macOS/MacSharedRelease.xcconfig "CURRENT_PROJECT_VERSION = 15"
